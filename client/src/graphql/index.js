...
export {
  default as CREATE_GROUP_MUTATION,
} from './groups/create-group.mutation';
export { default as LEAVE_GROUP_MUTATION } from './groups/leave-group.mutation';
export {
  default as DELETE_GROUP_MUTATION,
} from './groups/delete-group.mutation';
export {
  default as GROUP_ADDED_SUBSCRIPTION,
} from './groups/group-added.subscription';
...
export {
  default as CREATE_MESSAGE_MUTATION,
} from './messages/create-message.mutation';
export {
  default as MESSAGE_ADDED_SUBSCRIPTION,
} from './messages/message-added.subscription';
